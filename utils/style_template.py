style_list = [
    ...
    {
        "name": "Japanese Anime",
        "prompt": "anime artwork illustrating {prompt}. created by japanese anime studio. best quality, high resolution, (Anime Style, Manga Style:1.3), High detail, colorful",
        "negative_prompt":"lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry",
    },# highly emotional, sketch, concept art, line art，simple shades, minimalistic,，Linear compositions  hand drawn, defined lines, High contrast, Scalable artwork, Digital art, High Contrast Shadows",
    {
